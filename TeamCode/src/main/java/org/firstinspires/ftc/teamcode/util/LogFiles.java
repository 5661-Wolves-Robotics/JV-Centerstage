...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = Mecanum.TRANSLATIONAL_PID.kP;
        public double mecTransI = Mecanum.TRANSLATIONAL_PID.kI;
        public double mecTransD = Mecanum.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = Mecanum.HEADING_PID.kP;
        public double mecHeadingI = Mecanum.HEADING_PID.kI;
        public double mecHeadingD = Mecanum.HEADING_PID.kD;
        public double mecLateralMultiplier = Mecanum.LATERAL_MULTIPLIER;
