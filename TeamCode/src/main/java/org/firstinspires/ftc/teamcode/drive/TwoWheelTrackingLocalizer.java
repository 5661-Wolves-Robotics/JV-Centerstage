...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -2.011; // X is the up and down direction
    public static double PARALLEL_Y = -6.9488189; // Y is the strafe direction

    public static double PERPENDICULAR_X = -6.27952755;
    public static double PERPENDICULAR_Y = 0.1137896;

    public static double X_MULTIPLIER = 1.0289388437989599;
    public static double Y_MULTIPLIER = 1.0303085618925305;
