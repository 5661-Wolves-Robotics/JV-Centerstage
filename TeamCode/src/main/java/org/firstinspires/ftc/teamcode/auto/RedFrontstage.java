...
public class RedFrontstage extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        bot.init(hardwareMap, FieldConstants.RED_FRONTSTAGE_START, new MultipleTelemetry(telemetry, FtcDashboard.getInstance().getTelemetry()));
        drive = bot.getDrive();
        ...
        TrajectorySequence[] toJoin = {
                drive.trajectorySequenceBuilder(trajectories[0].end())
                        ...
                        .splineTo(new Vector2d(-52, -18), Math.toRadians(90))
